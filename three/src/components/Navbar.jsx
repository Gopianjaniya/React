      ...
      >
        <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
          ...
          <li className="md:mr-12">
            <button
              onClick={goToLogin}
              className="rounded-full border-2 border-white px-6 py-1 text-white transition-colors hover:bg-violet-500 hover:text-white mr-5"
            >
              Login
            </button>
            <button
              onClick={goToRegister}
              className="rounded-full border-2 border-white px-6 py-1 text-white transition-colors hover:bg-violet-500 hover:text-white"
            >
              Sign-up
            </button>
          </li>
