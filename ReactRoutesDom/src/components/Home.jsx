...
<div aria-label="Recent Posts" className="mx-auto mt-10 max-w-screen-xl py-20">
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div className="grid gap-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-2 xl:grid-cols-2 xl:gap-16">
      ...
      <div className="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
        <Link to="#" className="group shrink-0 relative block h-56 w-full self-start overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-24 md:w-24 lg:h-40 lg:w-40">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            <Link to="#" className="active:text-rose-600 transition duration-100 hover:text-rose-500">The Pines and the Mountains</Link>
          </h2>
          ...
          <div>
            <Link to="#" className="active:text-rose-700 font-semibold text-rose-500 transition duration-100 hover:text-rose-600">Read more</Link>
          </div>
        </div>
      </div>
      {/* <!-- /Article -->
      ...
      <div className="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            <Link to="#" className="active:text-rose-600 transition duration-100 hover:text-rose-500">The Coding Mania</Link>
          </h2>
      ...
      <div className="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            <Link to="#" className="active:text-rose-600 transition duration-100 hover:text-rose-500">Architectural Warfare</Link>
          </h2>
      ...
      <div className="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            <Link to="#" className="active:text-rose-600 transition duration-100 hover:text-rose-500">Blues in Architechture</Link>
          </h2>
